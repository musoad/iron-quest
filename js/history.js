      ...
      <div class="hq-wrap">
        <div class="hq-card" style="--aura:${classAura(clsSafe)}">
          ...
          <div class="hq-mini">
            ...
            <div class="hq-miniCard">
              <div class="hq-miniT">This Week</div>
              <div class="hq-miniV">${(totals.snapshot && totals.snapshot.week) ? (totals.snapshot.week.daysLogged + " days • +" + Math.round(totals.snapshot.totals.weekXp) + " XP") : "—"}</div>
              <div class="hq-miniS">
                <div class="miniBars">
                  <div class="miniBar"><div class="miniFill" style="width:${(totals.snapshot && totals.snapshot.week) ? Math.round(totals.snapshot.week.xpPct*100) : 0}%"></div></div>
                  <div class="miniLbl muted">${(totals.snapshot && totals.snapshot.week) ? Math.round(totals.snapshot.week.xpPct*100) : 0}% of goal</div>
                </div>
              </div>
            </div>
            <div class="hq-miniCard">
